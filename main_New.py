...
meanPatches = 5  # maximum (or mean) number of patches on each bead
...
L = ((4/3)*np.pi*N/0.1) ** (1/3)  # side-length of computational domain in particle radii, volume fraction 4% consistent with experiments
...
np.savetxt('posData_init_mean5_alpha6.out', pos, delimiter=' ')
np.savetxt('posBData_init_mean5_alpha6.out', posB, delimiter=' ')
...
np.savetxt('posData_mean5_alpha6.out', pos)
np.savetxt('posBData_mean5_alpha6.out', posB)
np.savetxt('energy_mean5_alpha6.out', energyOut)
